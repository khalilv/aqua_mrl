...
class evaluation(Node):
    def __init__(self):
        ...
        self.weight_path = '/usr/local/data/kvirji/AQUA/aqua_mrl/experiments/13/weights/episode_03300.pt'
        ...
        self.save_path = os.path.join('src/aqua_mrl/dqn_evaluations', self.experiment_name)
