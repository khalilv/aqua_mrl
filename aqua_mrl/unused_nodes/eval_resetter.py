...
nodes_list = ['supervisor','evaluation', 'dqn_adversary', 'default_server_', 'diver_controlle', 'autopilot', 'detect', 'current_control']
...
subprocess.Popen('ros2 run aqua_mrl evaluation --value {}'.format(value), shell=True)
